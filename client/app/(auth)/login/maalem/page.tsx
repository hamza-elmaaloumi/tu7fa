...
export default function LoginPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      // Note: Ideally, sensitive data shouldn't be in URL params (GET), 
      // but keeping your logic as requested.
      const res = await axios.get(`http://192.168.1.110:8000/users/maalem/login/${data.phoneNumber}/`);
      console.log("Login response:", res.data);
      
      setAlert({ show: true, message: 'Authentication successful. Redirecting...', type: 'success' });
      setUser({ type: 'maalem', id: res.data.id_maalem });
      console.log('Logged in maalem ID:', res.data.id_maalem);
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-10 space-y-3">
            ...
            <p className="text-neutral-500 text-sm">
              Secure entry for verified maalems.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <div className={`group relative flex items-center transition-all duration-300 border rounded-xl bg-neutral-950 ${errors.phoneNumber ? 'border-red-500/50' : 'border-neutral-800 focus-within:border-indigo-500/50 focus-within:ring-4 focus-within:ring-indigo-500/10'}`}>
        ...
        {alert.show && (
          <div className="absolute -bottom-20 left-0 right-0 flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className={`px-4 py-3 rounded-full border shadow-2xl backdrop-blur-md flex items-center gap-3 text-sm font-medium ${
              alert.type === 'success' 
